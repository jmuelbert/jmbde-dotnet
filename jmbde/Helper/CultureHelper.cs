...
namespace jmbde.Helper
{
    public static class CultureHelper
    {
        ...
        private static readonly List<string> _cultures = new List<string>
        {
            ...
            "es-ES" // Spanish NEUTRAL culture


        };

        /// <summary>
        /// Returns Ordered Langauges by Quality
        /// </summary>
        /// <param name="header">Header accepted language</param>
        /// <returns></returns>
        public static IOrderedEnumerable<StringWithQualityHeaderValue> ParserHeaderAcceptedLanguage(string header)
        {
        ...
        public static string GetImplementedCulture(string name)
        {
            ...
            if (!_validCultures.Where(c => c.Equals(name, StringComparison.InvariantCultureIgnoreCase)).Any())
                return GetDefaultCulture(); // return Default culture if it is invalid
            // if it is implemented, accept it
            if (_cultures.Where(c => c.Equals(name, StringComparison.InvariantCultureIgnoreCase)).Any())
