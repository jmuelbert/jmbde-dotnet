...
namespace jmbde.Controllers
{
    ...
    public class TitleController : Controller
    {
        ...
        /// Localization
        /// </summary>
        private readonly IStringLocalizer <TitleController> _localizer;

        /// <summary>
        /// ctor for the Controller
        /// </summary>
        /// <param name="context"></param>
        public TitleController(jmbdesqliteContext context, IStringLocalizer<TitleController> localizer) 
        {
            _context = context;
