...
namespace jmbde.Controllers
{
    ...
    public class ProcessorController : Controller
    {
        ...
        /// Localization
        /// </summary>
        private readonly IStringLocalizer <ProcessorController> _localizer;

        /// <summary>
        /// ctor for the Controller
        /// </summary>
        /// <param name="context"></param>
        public ProcessorController(jmbdesqliteContext context, IStringLocalizer<ProcessorController> localizer) 
        {
            _context = context;
