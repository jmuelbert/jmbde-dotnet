...
namespace jmbde.Controllers
{
    ...
    public class FunctionController : Controller
    {
        ...
        /// Localization
        /// </summary>
        private readonly IStringLocalizer <FunctionController> _localizer;

        /// <summary>
        /// ctor for the Controller
        /// </summary>
        /// <param name="context"></param>
        public FunctionController(jmbdesqliteContext context, IStringLocalizer<FunctionController> localizer) 
        {
            _context = context;
