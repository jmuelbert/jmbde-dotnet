...
namespace jmbde.Controllers
{
    ...
    public class SoftwareController : Controller
    {
        ...
        /// Localization
        /// </summary>
        private readonly IStringLocalizer <SoftwareController> _localizer;

        /// <summary>
        /// ctor for the Controller
        /// </summary>
        /// <param name="context"></param>
        public SoftwareController(jmbdesqliteContext context, IStringLocalizer<SoftwareController> localizer) 
        {
            _context = context;
