...
namespace jmbde.Controllers
{
    ...
    public class PlaceController : Controller
    {
        ...
        /// Localization
        /// </summary>
        private readonly IStringLocalizer <PlaceController> _localizer;

        /// <summary>
        /// ctor for the Controller
        /// </summary>
        /// <param name="context"></param>
        public PlaceController(jmbdesqliteContext context, IStringLocalizer<PlaceController> localizer) 
        {
            _context = context;
