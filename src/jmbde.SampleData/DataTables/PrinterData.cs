...
namespace GenSampleData.DataTables 
{
    public class PrinterData {
        ...
        public PrinterData() {
            ...
            _context = new JMBDEContext(optionsBuilder.UseSqlite("Data Source=../jmbde/app.db").Options);
        ...
        public void genData(int items) {
            ...
            A.Configure<Printer>()
                .Fill(c => c.PrinterId, () => { return i++; })
                .Fill(c => c.Name, () => { return String.Format("PRN{0:0000}",i++); })
                ...
                .Fill(c => c.Resources).WithRandom(new string[] {
                    "TONER1",
                    "TONER2",
                    "TONER3",
                    "TONER4",
                ...
                .Fill(c => c.Color).WithRandom( new bool[] { true, false, false});

            var printers = A.ListOf<Printer>(items);
