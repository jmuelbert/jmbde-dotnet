...
namespace JMuelbert.BDE.Pages.Printers { /// <summary>
    /// Details model.
    /// </summary>
    public class DetailsModel : PageModel {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:JMuelbert.BDE.Pages.Printers.DetailsModel"/> class.
        /// </summary>
        ...
        public async Task<IActionResult> OnGetAsync (int? id) {
            ...
            Printer = await _context.Printer.SingleOrDefaultAsync(m => m.ID == id)
