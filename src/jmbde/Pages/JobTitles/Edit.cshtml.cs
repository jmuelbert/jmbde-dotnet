...
namespace JMuelbert.BDE.Pages.JobTitles {
  ...
  public class EditModel : PageModel {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:JMuelbert.BDE.Pages.JobTitles.EditModel"/>
    /// class.
    /// </summary>
    ...
    public async Task<IActionResult> OnPostAsync(int? id) {
      ...
      if (await TryUpdateModelAsync<JobTitle>(jobtitleToUpdate,
                                              "jobtitle",  // Prefix for form value
                                              j => j.Name, j => j.FromDate, j => j.LastUpdate)
