...
namespace JMuelbert.BDE.Pages.JobTitles
{
    ...
    public class DetailsModel : PageModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:JMuelbert.BDE.Pages.JobTitles.DetailsModel"/>
        /// class.
        /// </summary>
        ...
        public async Task<IActionResult> OnGetAsync(int? id)
        {
            ...
            JobTitle =
                await _context.JobTitle.SingleOrDefaultAsync(m => m.ID == id).ConfigureAwait(false);
