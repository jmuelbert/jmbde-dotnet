...
namespace JMuelbert.BDE.Pages.Faxes {
  ...
  public class IndexModel : PageModel {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:JMuelbert.BDE.Pages.Faxes.IndexModel"/>
    /// class.
    /// </summary>
    ...
    public async Task OnGetAsync(string sortOrder, string currentFilter, string searchString,
      ...
      IQueryable<Fax> faxIQ = from f in _context.Fax select f;

      if (!String.IsNullOrEmpty(searchString)) {
        faxIQ =
            faxIQ.Where(fax => fax.Number.Contains(searchString, StringComparison.CurrentCulture));
      }
      ...
      int pageSize = 10;
      Fax =
          await PaginatedCollection<Fax>.CreateAsync(faxIQ.AsNoTracking(), pageIndex ?? 1, pageSize).ConfigureAwait(false);
    }
  }
}
