...
namespace JMuelbert.BDE.Pages.CityNames
{
	...
	public class DeleteModel : PageModel
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:JMuelbert.BDE.Pages.CityNames.DeleteModel"/>
		/// class.
		/// </summary>
		...
		public async Task<IActionResult> OnGetAsync(int? id, bool? saveChangesError = false)
		{
			...
			CityName = await _context.CityName.AsNoTracking()
		...
		public async Task<IActionResult> OnPostAsync(int? id)
		{
			...
			var cityname = await _context.CityName.AsNoTracking()
