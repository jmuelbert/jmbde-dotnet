...
namespace JMuelbert.BDE.Pages.Places { /// <summary>
    /// Edit model.
    /// </summary>
    public class EditModel : PageModel {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:JMuelbert.BDE.Pages.Places.EditModel"/> class.
        /// </summary>
        ...
        public async Task<IActionResult> OnGetAsync (long? id) {
            _logger.LogDebug ("Places/Edit/OnGetAsync");
        ...
        public async Task<IActionResult> OnPostAsync (long? id) {
            _logger.LogDebug ("Places/Edit/OnPostAsync");
