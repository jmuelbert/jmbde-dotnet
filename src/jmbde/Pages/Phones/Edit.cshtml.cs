...
namespace JMuelbert.BDE.Pages.Phones { /// <summary>
    /// Edit model.
    /// </summary>
    public class EditModel : PageModel {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:JMuelbert.BDE.Pages.Phones.EditModel"/> class.
        /// </summary>
        ...
        public async Task<IActionResult> OnGetAsync (long? id) {
            _logger.LogDebug ("Phones/Edit/OnGetAsync");
            if (id == null) {
                return NotFound ();
            }
        ...
        public async Task<IActionResult> OnPostAsync (long? id) {
            _logger.LogDebug ("Phones/Edit/OnPostAsync");
