...
namespace JMuelbert.BDE.Pages.Phones {
    ...
    public class DetailsModel : PageModel {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:JMuelbert.BDE.Pages.Phones.DetailsModel"/> class.
        /// </summary>
        ...
        public async Task<IActionResult> OnGetAsync (long? id) {
            ...
            Phone = await _context.Phone.SingleOrDefaultAsync (m => m.PhoneId == id).ConfigureAwait (false);
