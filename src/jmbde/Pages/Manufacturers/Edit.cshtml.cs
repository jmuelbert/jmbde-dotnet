...
namespace JMuelbert.BDE.Pages.Manufacturers {
    ...
    public class EditModel : PageModel {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:JMuelbert.BDE.Pages.Manufacturers.EditModel"/> class.
        /// </summary>
        ...
        public async Task<IActionResult> OnGetAsync (long? id) {
            _logger.LogDebug ("Manufacturers/Edit/OnGetAsync");
            if (id == null) {
                return NotFound ();
            }
        ...
        public async Task<IActionResult> OnPostAsync (long? id) {
            _logger.LogDebug ("Manufacturers/Edit/OnPostAsync");
