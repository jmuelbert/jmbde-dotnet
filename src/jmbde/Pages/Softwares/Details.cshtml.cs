...
namespace JMuelbert.BDE.Pages.Softwares
{
	...
	public class DetailsModel : PageModel
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:JMuelbert.BDE.Pages.Softwares.DetailsModel"/>
		/// class.
		/// </summary>
		...
		public async Task<IActionResult> OnGetAsync(int? id)
		{
			...
			Software =
				await _context.Software.SingleOrDefaultAsync(m => m.ID == id).ConfigureAwait(false);
