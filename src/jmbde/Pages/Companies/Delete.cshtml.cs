...
namespace JMuelbert.BDE.Pages.Companies {
  ...
  /// Delete model.
  /// </summary>
  public class DeleteModel : PageModel {  /// <summary>
                                          /// The context.
                                          /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:JMuelbert.BDE.Pages.Companies.DeleteModel"/>
    /// class.
    /// </summary>
    ...
    public async Task<IActionResult> OnGetAsync(int? id, bool? saveChangesError = false) {
      ...
      Company = await _context.Company.AsNoTracking()
    ...
    public async Task<IActionResult> OnPostAsync(int? id) {
      ...
      var company = await _context.Company.AsNoTracking()
                        .FirstOrDefaultAsync(c => c.ID == id)
                        .ConfigureAwait(false);
